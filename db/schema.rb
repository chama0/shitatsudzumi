...
ActiveRecord::Schema.define(version: 2021_04_17_004958) do
  ...
  create_table "howtomakes", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.text "text", null: false
    t.string "image", null: false
    t.bigint "recipe_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["recipe_id"], name: "index_howtomakes_on_recipe_id"
  end
  ...
  add_foreign_key "howtomakes", "recipes"
